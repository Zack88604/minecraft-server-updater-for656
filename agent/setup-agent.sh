...
# Appends -javaagent configuration to Minecraft client JVM arguments.
#
# Usage:
...
#
# This script appends the -javaagent argument to user_jvm_args.txt
# (or vmoptions file) inside the instance directory.
